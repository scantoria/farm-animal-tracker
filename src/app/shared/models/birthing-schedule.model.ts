...
export interface BirthingSchedule {
  ...
  calvingEase?: string | null; // e.g., 'Easy', 'Assisted', 'Hard Pull'
  notes?: string | null;
  ...
  sire?: string | null; // The ID or name of the father
  sex: string; // 'bull', 'heifer', 'colt', 'filly', 'doe', 'buck', 'ewe', 'ram'
  birthWeight?: string | null; // The weight of the calf at birth (string to accommodate units or N/A)
